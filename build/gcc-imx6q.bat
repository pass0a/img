...
cmake ../../3rd/libjpeg-turbo -G "%GENERATOR%" %TOOLCHAIN% -DCMAKE_INSTALL_PREFIX=../../stage -DPASSOA3RD=ON -DCMAKE_ARM_GCC=E:/usr/linaro/gcc -DCMAKE_MAKE_PROGRAM=E:/usr/linaro/gcc/bin/make.exe
